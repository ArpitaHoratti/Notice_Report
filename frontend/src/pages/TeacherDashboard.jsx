...
import {
  downloadNoticeAsWord,
} from "../utils/downloadNotice";
            ...
            <section className="dashboard-cards">
              ...
              >
                ...
                <p>
                  ...
                  notices using the Jabin
                  Science College template
                  with Word & PDF export.
                </p>
              ...
              <div
                className={`dashboard-card filter-card ${
                  activeTab === "PENDING"
                    ? "card-selected"
                    : ""
                }`}
          ...
          >
            ...
            <div className="modal-body">
              ...
              <p>
                ...
                <span
                  className={`status ${
                    selectedDoc.status.toLowerCase()
                  }-status`}
                >
                  {selectedDoc.status}
                </span>
                ...
                onClick={() => {
                  ...
                  if (
                    ...
                    selectedDoc.type === "Report"
                      ? "report"
                      : selectedDoc.type === "Agenda"
                      ? "agenda"
                      : selectedDoc.type === "College Format"
                      ? "clgformat"
                      : "notice";
